...
// - отдельный пакет @radix-ui/* вместо мета-пакета `radix-ui`, импорт `cn` из @/lib/utils;
// - без классов анимации появления (tw-animate-css не подключён: интерфейс без декоративной
//   анимации);
// - без CheckboxItem (не используется; тип `checked` несовместим с exactOptionalPropertyTypes).
